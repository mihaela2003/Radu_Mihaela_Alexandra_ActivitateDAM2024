...
public class APINinjaQuotes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apininja_quotes);
                    ...
                    public void run() {
                        ...
                        try{
                            ...
                            for(int i=0;i<responseArray.length();i++){
                                ...
                                rez.append(quote+"-"+author+"\n");
                            }
                        handler.post(new Runnable() {
                            @Override
                            public void run() {
                                TextView tvRezultat = findViewById(R.id.TVNinjaApi);
