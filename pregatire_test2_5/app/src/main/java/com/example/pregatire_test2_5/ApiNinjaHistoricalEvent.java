...
public class ApiNinjaHistoricalEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_api_ninja_historical_event);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = "https://api.api-ninjas.com/v1/historicalevents?text=" + search;
                    ...
                    public void run() {
                        ...
                        try{
                            ...
                            for(int i = 0; i<responseArray.length();i++){
                                ...
                                rez.append(year+"-"+month+"-"+day+"->"+event+"\n");
                            }
